...
## Issue #51 review-dispatch failures (Agent Garden)
...
- Review card assigned to `minimax-implementer` (Agent Garden review worker) but left in `ready` status is routed through implementation dispatch and skipped/blocked.
